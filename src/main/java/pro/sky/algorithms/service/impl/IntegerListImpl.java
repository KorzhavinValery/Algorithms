...
import pro.sky.algorithms.service.IntegerList;
...
public class IntegerListImpl implements IntegerList {
    ...
    public Integer remove(Integer item) {
        ...
        if (index == -1) throw new ItemNotFoundException(); //самодельное RunTime исключение
    ...
    private void sortQuickForPartition(int begin, int end) {
        if (begin < end) {
